...
/**
 * PasswordTag creates a simple input element of password type.
 */
class PasswordTag extends AbstractTag
{
    ...
    /**
     * Returns HTML of the password element.
     *
     * @return string
     */
    public function __toString()
    {
        ...
        return $this->FormHelper->password($this->fieldName, $options);
    }
}
